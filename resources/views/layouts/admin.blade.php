        ...
        <nav class="navbar navbar-expand-md navbar-ligth  shadow-sm" style="border-bottom:4px solid rgba(193, 245, 180, 0.747)">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!-- searchbar Of Navbar -->
                    <form action="{{route('admin.search')}}" class="form-inline my-2 mx-2 my-lg-0 d-flex" method="GET">
...
{{--     
    <script>
        ...
        document.addEventListener('scroll', (event) =>{
            console.log('altezza totale ' + scrollHeight);
            console.log('altezza corrente: ' + scrolltop);
            console.log('altezza corrente rispetto alla posizione iniziale: '+ window.pageYOffset);
            console.log('altezza schermo '+ document.documentElement.clientHeight)
